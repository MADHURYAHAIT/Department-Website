  ...
  return (
   <>
    ...
    <div class="header-menu">
        ...
        <a class="main-header-link is-active" href="/council">Council</a>
      ...
      <div class="container">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up">
              <div class="pic"><img src="./images/ankit.jpeg" class="img-fluid" alt=""/></div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up">
              <div class="pic"><img src="./images/anushree.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up">
              <div class="pic"><img src="./images/rafiullah.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up">
              <div class="pic"><img src="./images/sambhav.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up">
              <div class="pic"><img src="./images/akhil.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="150">
              <div class="pic"><img src="./images/ahana.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
                <h4>Ahana Sadh</h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="pic"><img src="./images/nithin.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="pic"><img src="./images/sneha.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="pic"><img src="./images/shubham.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
                <h4>M. Nithin Reddy</h4>
                <span>Representative Boys</span>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="pic"><img src="./images/aniket.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
                <h4>Aniket Rai</h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="pic"><img src="./images/shivam.jpeg" class="img-fluid" alt=""/></div>
              <div class="member-info">
                <h4>Shivam Saurav</h4>
