...
function App() {
  useEffect(() => {
    ...
    document.querySelectorAll(".menu-link").forEach(link => link.addEventListener("click", handleMenuLinkClick));
    document.querySelectorAll(".main-header-link").forEach(link => link.addEventListener("click", handleMainHeaderLinkClick));
    document.querySelectorAll(".dropdown").forEach(dropdown => dropdown.addEventListener("click", handleDropdownClick));
    document.querySelector(".search-bar input").addEventListener("focus", handleSearchBarFocus);
    document.querySelector(".search-bar input").addEventListener("blur", handleSearchBarBlur);
    document.addEventListener("click", handleDocumentClick);
    document.querySelectorAll(".dropdown").forEach(dropdown => dropdown.addEventListener("click", handleDropdownClickOverlay));
    document.addEventListener("click", handleDocumentClickOverlay);
    document.querySelectorAll(".status-button:not(.open)").forEach(button => button.addEventListener("click", handleStatusButtonClick));
    document.querySelectorAll(".pop-up .close").forEach(button => button.addEventListener("click", handleCloseButtonClick));
    document.querySelector(".dark-light").addEventListener("click", handleToggleButtonClick);
    
    // Cleanup function
    return () => {
      document.querySelectorAll(".menu-link").forEach(link => link.removeEventListener("click", handleMenuLinkClick));
      document.querySelectorAll(".main-header-link").forEach(link => link.removeEventListener("click", handleMainHeaderLinkClick));
      document.querySelectorAll(".dropdown").forEach(dropdown => dropdown.removeEventListener("click", handleDropdownClick));
      document.querySelector(".search-bar input").removeEventListener("focus", handleSearchBarFocus);
      document.querySelector(".search-bar input").removeEventListener("blur", handleSearchBarBlur);
      document.removeEventListener("click", handleDocumentClick);
      document.querySelectorAll(".dropdown").forEach(dropdown => dropdown.removeEventListener("click", handleDropdownClickOverlay));
      document.removeEventListener("click", handleDocumentClickOverlay);
      document.querySelectorAll(".status-button:not(.open)").forEach(button => button.removeEventListener("click", handleStatusButtonClick));
      document.querySelectorAll(".pop-up .close").forEach(button => button.removeEventListener("click", handleCloseButtonClick));
      document.querySelector(".dark-light").removeEventListener("click", handleToggleButtonClick);
    };
  }, []);
      ...
      <div className="app">
        <div className="header">
          ...
          <div className="header-profile">
            ...
            <a href='https://www.linkedin.com/in/madhuryahait/'><img className="profile-img" src="./images/profilepic.png" alt="Madhurya Hait" /></a>
          </div>
        </div>
